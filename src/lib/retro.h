...
void RETRO_BitBlit(unsigned char *src, int size = RETRO_WIDTH * RETRO_HEIGHT, unsigned char *dest = RETRO.framebuffer, int alpha = 0)
{
...
unsigned char *RETRO_LoadImage(const char *filename, bool setpalette = false)
{
